            ...
            <div className="px-6 lg:px-8 ">
                <div className="mx-auto max-w-7xl pt-16 sm:pt-20 pb-20 banner-image">
                    <div className="text-center">
                        ...
                        Bienvenue chez KodeYo <br/>Votre Partenaire en Innovation Technologique
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-bluegray">
                        Nous visons à améliorer votre expérience au quotidien en répondant aux besoins essentiels à travers ,<br/> des solutions numériques dans des secteurs variés. 
                        </p>
                    </div>
